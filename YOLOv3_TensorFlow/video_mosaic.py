...
parser.add_argument("--input_video", type=str, default="./data/demo_video/test_video.mp4",
...
parser.add_argument("--restore_path", type=str, default="./checkpoint/new_best_model3_18.ckpt",
...
import os
os.makedirs("./data/demo_video_results", exist_ok=True)

if args.input_video.find('/') == 1:
    video_full_name = args.input_video.split('/')[-1]
    video_name = video_full_name.split('.')[0]
else:
    video_full_name = args.input_video
    video_name = video_full_name.split('.')[0]
...
if args.save_video:
    ...
    videoWriter = cv2.VideoWriter('./data/demo_video_results/{}.mp4'.format(video_name), fourcc, video_fps, (video_width, video_height))
